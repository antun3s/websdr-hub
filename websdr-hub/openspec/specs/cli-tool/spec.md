...
Interface de linha de comando unificada (`websdrctl`) com subcomandos `validate`, `build` e `check`. Ponto de entrada para validação do catálogo, geração da API estática e execução do health check.
